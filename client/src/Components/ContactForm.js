        ...
        <div>
            <Grid container className={classes.wrapperContact}>
                ...
                <Grid container className={classes.contentContact}>
                    ...
                    <Grid item className={classes.timeWork}>
                        <CardContent>
                            <Typography className={classes.title} color="textSecondary" gutterBottom>
                                Режим работы</Typography>
                            <Typography className={classes.pos} color="textSecondary">
                                Россия, 630084, Новосибирск</Typography>
                        </CardContent>
                        <CardActions>
                    ...
                    <Grid item className={classes.emailMeneger}>
                        <CardContent>
                            <Typography className={classes.title} color="textSecondary" gutterBottom>
                                Адрес</Typography>
                            <Typography className={classes.pos} color="textSecondary">
                    ...
                    <Grid item className={classes.social}>
                        <CardContent>
                            <Typography className={classes.title} color="textSecondary" gutterBottom>
                                Мы в социальных сетях</Typography>
                            <Typography className={classes.pos} color="textSecondary">
                                Россия, 630084, Новосибирск</Typography>
                        </CardContent>
                        <CardActions>
                    ...
                    <Grid item className={classes.bank}>
                        <CardContent>
                            <Typography className={classes.title} color="textSecondary" gutterBottom>
                ...
                <Grid container className={classes.dialog}>
                    <Grid item className={classes.mapGoogle}>

                    </Grid>
                    <Grid item className={classes.formDialog}>
                        <FormDialog />
                    </Grid>
                </Grid>
            </Grid>
